...
\begin{document}
	...
	\chapter{Nền tảng lý thuyết: Hệ thống Naive RAG và Giới hạn của nó}
	\label{chap:naive_rag}

	\section{Tại sao cần RAG? Hạn chế của Mô hình Ngôn ngữ Lớn}
	\label{sec:llm_limitations}

	Trong thực tế triển khai hệ thống tư vấn tuyển sinh tại Trường Đại Học Khoa
	Học, chúng tôi nhanh chóng nhận ra rằng việc dùng một mô hình ngôn ngữ lớn
	đơn thuần không giải quyết được bài toán. Điều này không phải do mô hình kém
	mà do bốn hạn chế cố hữu về bản chất của chính LLM~\cite{neo4j2024essential}
	--- những hạn chế không thể khắc phục bằng cách mở rộng quy mô hay kéo dài
