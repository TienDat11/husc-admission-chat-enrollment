...
url = 'http://export.arxiv.org/api/query?search_query=all:"GraphRAG"+OR+all:"Graph-based+Retrieval-Augmented+Generation"&sortBy=submittedDate&sortOrder=descending&max_results=10'
